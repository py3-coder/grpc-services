...
const (
	...
	UserService_GetUsersByIds_FullMethodName = "/proto.UserService/GetUsersByIds"
)
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *UserIdsRequest, opts ...grpc.CallOption) (*UserListResponse, error) {
...
func (UnimplementedUserServiceServer) GetUsersByIds(context.Context, *UserIdsRequest) (*UserListResponse, error) {
